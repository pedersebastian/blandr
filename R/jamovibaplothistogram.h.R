...
jamoviBAplotHistogramOptions <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
...
jamoviBAplotHistogramResults <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "jamoviBAplotHistogramResults",
...
jamoviBAplotHistogramBase <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
