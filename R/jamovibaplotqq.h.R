...
jamoviBAplotQQOptions <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
...
jamoviBAplotQQResults <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "jamoviBAplotQQResults",
...
jamoviBAplotQQBase <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "jamoviBAplotQQBase",
