...
jamoviBAanalysisOptions <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
...
jamoviBAanalysisResults <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "jamoviBAanalysisResults",
...
jamoviBAanalysisBase <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
...
#' Bland-Altman analysis for Jamovi
#'
#' 
#' @param data .
#' @param method1 .
